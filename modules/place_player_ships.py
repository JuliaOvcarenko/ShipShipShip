...
def check_cells():
    ...
    def check_cells_plus(lenght):
        ...
        for value in range(lenght):
            ...
            if data.unplaced_ship.ANGLE == 0 and data.unplaced_ship.CELL[1]+value<9:
            ...
            elif data.unplaced_ship.ANGLE == 270 and data.unplaced_ship.CELL[0]+value<9:
                if data.player_map[data.unplaced_ship.CELL[0]+value][data.unplaced_ship.CELL[1]].ITEM == 0:
                    # збільшування list_cells на 1
                    list_cells += 1
...
def place_busy_cells():
    def place_busy_cells_plus(lenght):
        for value in range(abs(lenght)+2):
            value_edit = value - 1
            if data.unplaced_ship.ANGLE == 270:
                if data.unplaced_ship.CELL[0] + value_edit >= 0 and data.unplaced_ship.CELL[0] + value_edit <= 9 and data.unplaced_ship.CELL[0] - value_edit >= 0 and  data.unplaced_ship.CELL[0] - value_edit <= 9:
                ...
                if data.unplaced_ship.CELL[1] + value_edit >= 0 and data.unplaced_ship.CELL[1] + value_edit <= 9 and data.unplaced_ship.CELL[1] - value_edit >= 0 and  data.unplaced_ship.CELL[1] - value_edit <= 9:
