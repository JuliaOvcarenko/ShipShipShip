        ...
        if line == 0:
            ...
            if -1 < shoot[0] < 10 and -1 < shoot[1] < 10:
                ...
                if data.player_map[shoot[0]][shoot[1]].EFFECT == 0:
                    ...
                    if end_of_line==0:
                        if data.player_map[shoot[0]][shoot[1]].ITEM == 0 and data.player_map[shoot[0]][shoot[1]].ITEM == "Busy":
                            print('EENNNDDDDDDDDDD')                            
                            prev_shoot = shoot
                    ...
                    if data.player_map[shoot[0]][shoot[1]].ITEM == "Ship" and end_of_line==1:
                        print("BOOOOOOOOMMMMMMMMMMMMMMM end")
                        shoot_place = 1
